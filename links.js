...
let nuget_packages = [
    ...
    ["https://github.com/isaiahnoelsalazar/NETSimpleFunctions/", "NETSimpleFunctions (.NET 6.0+)", "Provides a collection of utility functions to speed up development for .NET 6.0+."]
];
let python_packages = [
